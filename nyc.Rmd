...
```{r Join both data sets (SCHMA + grad-rates2005-2010 + demo2006-2016)}
...
```{r 2005 Replaced and Replacement Schools, echo = FALSE}
...
```{r Visualizing failed but still open schools in 2005, echo = FALSE}
...
# Data for failinig large schools in 2005 that are still open and maintain size
# Data
...
```{r Compare Replacement Schools with Large Failing Open Schools in 2005, echo = TRUE}
