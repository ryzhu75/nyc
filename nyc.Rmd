...
data_join %>% 
  ...
  geom_col()+ 
  labs(title = "Number of High Schools with Enrollment ≤ 600 from 2005-2015") +
  scale_y_continuous(name = "# High Schools",
                     limits = c(0, 500)) +
  scale_x_continuous(name = "School Year (aA second trend resulting from the aggressive small schools policy is a decrease in the number of large high schools and a significant increase in the number of small schools. [HS600 FIG] shows the magnitude and speed at which this policy was implemented. The number of schools with enrollment fewer than or equal to 600 rises dramatically after the 2004-2005 school year until the mid 2010s. This points to a strong correlation between an increasing number of small schools and rising graduation outcomes. s of June)") +
  theme_classic() +
