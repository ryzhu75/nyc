...
data_failing_open <- data_join %>% 
  ...
  select(dbn, school, year, total_grads_percent_of_cohort, enrnumg12) %>% 
  ...
  # Filter for schools where graduation rates falls in the failing schools closed middle 50th percentile
