...
data_join %>% 
  ...
  labs(title = "Number of High Schools with Enrollment ≤ 600 2000-2015",
       caption = expression(paste(italic("Sources: "), "NYCDOE (2019), NYCDOE (2013), Research Alliance for NYC Schools (2016)"))) +
...
replacement_schools_vs_all_failing %>% 
  ...
  ggplot(aes(x = year, y = avg_grad, shape = data_cat)) +
  ...
  labs(title = "Average Graduation Rates 2005-2015",
       ...
       caption ="Values for the treated group in 2006 were omitted due to too few observations \n Values for the pretreatment group was omitted after 2008 due to too few observations") +
...
replacement_schools_grad_vs_failing %>% 
  ...
  geom_point(aes(shape = data_cat), size = 3) +
  geom_line() +
  labs(title = "Average HS Enrollment 2005-2015",
...
grad_rates_nest %>% 
  ...
  labs(title = "High School Graduation Rates 2005-2015",
       ...
       caption = expression(paste(italic("Sources: "), "NYCDOE (2019), NYCDOE (2013)")),
       y = "Graduation Rate",
       x = "School Year (as of June)") +
...
demo_closed05_20002005_plot + 
  ...
  # cut off text
  plot_annotation(caption = expression(paste(italic("Sources: "), "NYCDOE (2013), Research Alliance for NYC Schools (2016)")), 
